# Generated by Powerlevel10k configuration wizard on 2022-09-30 at 20:03 EDT.
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_VISUAL_IDENTIFIER_EXPANSION='⌛︎'
  # Custom prefix.
  ...
  typeset -g POWERLEVEL9K_BATTERY_BACKGROUND=5
